...
type Props = { open: boolean; onOpenChange: (v: boolean) => void; student?: Student | null };
...
export function StudentDialog({ open, onOpenChange, student }: Props) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Capture personal, academic, guardian, fee, transport, hostel, medical and document
            details.
          </DialogDescription>
        </DialogHeader>
