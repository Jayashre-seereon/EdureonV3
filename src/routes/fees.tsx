...
import { IndianRupee, TrendingUp, AlertCircle, CreditCard, Download, Plus, MoreHorizontal, Pencil, Trash2, Receipt, RefreshCcw } from "lucide-react";
...
import { useFeeTxns, feeApi, type FeeTxn } from "@/lib/store";
  ...
  return (
    <PageContainer>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <KpiCard label="Outstanding Dues" value={inr(2160000)} delta={-3.4} icon={<AlertCircle className="h-5 w-5" />} tone="warning" />
        <KpiCard label="Online Payments" value="83%" delta={4.2} icon={<CreditCard className="h-5 w-5" />} tone="info" />
