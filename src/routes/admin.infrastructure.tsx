...
import { ChevronRight, ChevronDown, Building2, Layers, DoorOpen, Plus, Search, Trash2, Pencil } from "lucide-react";
...
function InfraPage() {
  ...
  return (
    <PageContainer>
      ...
      <CrudDialog open={addBuilding} onOpenChange={setAddBuilding} title="Add Building"
        ...
        fields={[
          ...
          { name: "purpose", label: "Purpose", type: "select", options: ["Classrooms", "Laboratories", "Administration", "Sports", "Hostel", "Other"] },
        ]}
        submitLabel="Create Building"
        onSubmit={(d) => updateTree((p) => [...p, { name: String(d.name), code: String(d.code), purpose: String(d.purpose), blocks: [] }])}
      />
