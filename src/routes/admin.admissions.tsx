  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        actions={
          <NewInquiryDialog
            trigger={<Button size="sm" className="gradient-primary border-0"><Plus className="h-4 w-4" />New Inquiry</Button>}
            onCreate={(d) => {
              const id = inquiriesApi.add({
                name: d.name, class: d.class, parent: d.parent, phone: d.phone,
                email: d.email || "—", source: d.source as Inquiry["source"], stage: "Inquiry",
